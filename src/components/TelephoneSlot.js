...
class TelephoneSlot extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            webId: "",
            currentValue: this.props.telephone,
            newValue: this.props.telephone[0].split(":")[1],
            editMode: false
        };
    }
    ...
    render(){
        ...
        return (
            <Row style={{border: "solid #FFF 5px", borderRadius: "10", width: "100%"}}>
                ...
                <Col md="4">
                    <Row style={{width: "100%"}}>
                        <PublicCardButton webId={this.props.webId} email={this.props.currentValue}/>
                    </Row>
                </Col>
            </Row>
        )
